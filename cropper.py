...
label_get_input = tk.Label(frame_input, text = "Sélectionnez une image: ")
...
entry_input_image = tk.Entry(main_frame, textvariable = input_image_path, width = 100, state = "disable")
...
label_get_save_path = tk.Label(frame_save, text = "Sélectionnez où sauvegarder l'image traitée: ")
save_path = tk.StringVar(frame_save)
save_path.set("")
button_get_save_path = tk.Button(frame_save, text = "Naviguer...",
                                 command = lambda : browse_output_dir(input_image_path, save_path))
entry_show_save_path = tk.Entry(main_frame, textvariable = save_path, width = 100, state = "disable")
button_go_save = tk.Button(main_frame, text = "Savegarder",
                           command = lambda: save_cropped_image(input_image_path, save_path, is_saved))
...
label_get_save_path.grid(row = 0, column = 0, sticky = "W")
button_get_save_path.grid(row = 0, column = 1, sticky = "W")
entry_show_save_path.grid(row = 5, column = 0, padx = 10, sticky = "W")
